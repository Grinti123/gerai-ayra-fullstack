...
const Add = ({token}) => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
        <div>
           <p className='mb-2'>Upload Gambar Produk</p>
        ...
        <div className='w-full'>
          ...
          <input onChange={(e) => setName(e.target.value)} value={name} className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='Nama Produk' required/>
        </div>
        <div className='w-full'>
          <p className='mb-2'>Deskripsi Produk</p>
          <textarea onChange={(e) => setDescription(e.target.value)} value={description} className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='Masukkan Deskripsi' required/>
        </div>
        ...
        <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
          ...
          <div>
            ...
            <input onChange={(e) => setPrice(e.target.value)} value={price} className='w-full px-3 py-2 sm:w-[120px]' type="number" placeholder='Rp.'/>
          </div>
        ...
        <div className='flex gap-2 mt-2'>
          ...
          <label className='cursor-pointer' htmlFor="bestseller">Masukkan di Best Seller</label>
        </div>

        <button type='submit' className='w-28 py-3 mt-4 bg-black text-white rounded-lg'>Tambah</button>
