                    ...
                    {token &&
                        <div className="group-hover:block hidden absolute dropdown-menu right-0 pt-4 z-20" >
                            <div className="flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded shadow-lg" >
                                ...
                                <p onClick={() => navigate('/returns')} className="cursor-pointer hover:text-black transition-colors">My Returns</p>
                                <p onClick={logout} className="cursor-pointer hover:text-black transition-colors">Logout</p>
                            </div>
                        </div>}
                </div>
                <Link to="/wishlist" className="relative group/wishlist" >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 cursor-pointer group-hover/wishlist:text-red-500 transition-colors">
