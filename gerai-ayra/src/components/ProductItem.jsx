            ...
            <div className='relative bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden border border-gray-100 hover:border-accent-200'>
                ...
                <div className='relative aspect-[4/5] overflow-hidden rounded-t-2xl bg-gray-100'>
                    ...
                    <div className={`absolute top-4 right-4 transition-all duration-300 ${
                        ...
                        <button className='w-10 h-10 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg hover:bg-white transition-colors duration-200 group/btn'>
                            <svg className='w-5 h-5 text-gray-700 group-hover/btn:text-accent-600 transition-colors duration-200' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                    ...
                    <div className={`absolute bottom-4 left-1/2 -translate-x-1/2 transition-all duration-300 ${
                        ...
                        <button className='px-4 py-2 bg-white/90 backdrop-blur-sm rounded-full text-sm font-medium text-gray-800 hover:bg-white transition-colors duration-200 shadow-lg'>
                            Quick View
                        </button>
                    </div>
                </div>
